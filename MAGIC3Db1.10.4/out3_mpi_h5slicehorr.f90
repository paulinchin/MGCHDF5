...
! =========================================================
      subroutine outsliceh(maxmx,maxmy,maxmz,meqn,mbc,mx,my,&
...
! This routine is to output a range of horizontal slices
    ...
    allocate (attr_data(3,np))
     ...
     & // '.h5'
       ...
       l = 0
     ! as "k" - set range of grid points from mz to output
      do k=71,120
      l=l+1
      do j=1,my
      do i=1,mx
      do m=1,meqn
      data(i,j,l,m) = q(m,i,j,k)
      end do
      end do
      end do
      end do
